...
export default function Master(props) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      if (projectListRef.current) {
        ...
        projectListRef.current.scrollBy({
          top: e.deltaY * 0.1, // Reduce scroll speed to 5% of original
          behavior: "auto",
        });
      }
    };
    ...
    if (projectList) {
      projectList.addEventListener("wheel", handleWheel, { passive: false });
    }

    return () => {
      if (projectList) {
        projectList.removeEventListener("wheel", handleWheel);
      }
    };
  }, []);
      ...
      {valid ? (
        ...
        >
          <div className="rotateScreenWrapper">
            <div className="rotateScreenText">
              Work in progress for mobile version!
            </div>
          </div>
        </Html>
      ) : (
        <group>
          ...
          <Html
            ...
            portal={{ current: scroll.fixed }}
          >
            <div className="projectListWrapper" ref={projectListRef}>
